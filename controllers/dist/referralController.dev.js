...
function () {
  ...
  _createClass(ReferralController, [{
    ...
    value: function getReferralSettings() {
      var settings;
      return regeneratorRuntime.async(function getReferralSettings$(_context) {
        while (1) {
    ...
    value: function updateReferralSettings(updateData) {
      var settings;
      return regeneratorRuntime.async(function updateReferralSettings$(_context2) {
        while (1) {
    ...
    value: function handleReferralSettings(chatId) {
      ...
      return regeneratorRuntime.async(function handleReferralSettings$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              message = "\uD83C\uDFAF Referal Ballari Sozlamalari\n\n" + "\uD83D\uDCB0 Joriy referal ball: ".concat(settings.referralPoints, " ball\n\n") + "Har bir taklif qilgan do'stingiz uchun beriladigan ball miqdorini o'zgartiring:";
              _context3.next = 6;
              return regeneratorRuntime.awrap(this.bot.sendMessage(chatId, message, require('../config/keyboards').referralSettingsKeyboard));
    ...
    value: function changeReferralPoints(chatId, newPoints) {
      var points, settings;
      return regeneratorRuntime.async(function changeReferralPoints$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 5:
              _context4.next = 7;
              return regeneratorRuntime.awrap(this.updateReferralSettings({
            ...
            case 7:
              ...
              _context4.next = 10;
              return regeneratorRuntime.awrap(this.bot.sendMessage(chatId, "\u2705 Referal ballari muvaffaqiyatli o'zgartirildi!\n\n" + "\uD83C\uDFAF Yangi referal ball: ".concat(settings.referralPoints, " ball\n\n") + "\u2B05\uFE0F Orqaga qaytish uchun \"Ballar\" bo'limiga kiring.", {
                reply_markup: {
                  keyboard: [['⬅️ Orqaga']],
