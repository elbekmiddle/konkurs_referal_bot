...
var SubscriptionController = {
  ...
  handleStartSubscription: function handleStartSubscription(chatId, userData, startParam, bot) {
    var user, isNewUser, referrer, subscriptionResult, welcomeMessage, subscriptionMessage;
    return regeneratorRuntime.async(function handleStartSubscription$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 20:
            _context.next = 22;
            return regeneratorRuntime.awrap(ChannelService.checkAllSubscriptions(chatId, bot));
          ...
          case 27:
            welcomeMessage = isNewUser ? "\uD83C\uDF89 Xush kelibsiz, ".concat(user.firstName, "!\n\nBotdan to'liq foydalanishingiz mumkin.") : "\uD83D\uDC4B Yana bir bor salom, ".concat(user.firstName, "!");
          ...
          case 31:
            ...
            subscriptionMessage = this.formatSubscriptionMessage(subscriptionResult.results);
            return _context.abrupt("return", {
              success: false,
  ...
  formatSubscriptionMessage: function formatSubscriptionMessage(channels) {
    var message = "\u26A0\uFE0F Iltimos, quyidagi kanallarga obuna bo'ling:\n\n";
    channels.forEach(function (channel, index) {
      var status = channel.isSubscribed ? '✅' : '❌';
      message += "".concat(status, " ").concat(channel.channelName, "\n\uD83D\uDD17 ").concat(channel.channelLink, "\n\n");
    });
  ...
  handleSubscriptionCheck: function handleSubscriptionCheck(chatId, bot) {
    ...
    return regeneratorRuntime.async(function handleSubscriptionCheck$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 15:
            _context2.next = 17;
            return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\u2705 Barcha kanallarga obuna bo'lgansiz!\n\n" + "\uD83C\uDF89 Endi botdan to'liq foydalanishingiz mumkin.", this.getMainKeyboard(user.isAdmin)));
          ...
          case 19:
            message = this.formatSubscriptionMessage(subscriptionResult.results);
            _context2.next = 22;
            return regeneratorRuntime.awrap(bot.sendMessage(chatId, message, this.getSubscriptionKeyboard()));
          ...
          case 24:
            ...
            _context2.next = 29;
            return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Tekshirishda xatolik yuz berdi'));
