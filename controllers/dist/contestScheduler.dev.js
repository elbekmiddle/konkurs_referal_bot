    ...
    _createClass(ContestScheduler, [
              ...
              while (1) {
                switch ((_context6.prev = _context6.next)) {
                  ...
                  case 3:
                    ...
                    _context6.next = 9;
                    return regeneratorRuntime.awrap(
                      this.notifyContestStart(contest),
                    );
              ...
              while (1) {
                switch ((_context8.prev = _context8.next)) {
                  ...
                  case 13:
                    ...
                    winnerCount = Math.min(
                      contest.winnersCount,
                      sortedParticipants.length,
                    );
                    winners = sortedParticipants
                      .slice(0, winnerCount)
                      .map(function (w) {
                        return w.chatId;
                  ...
                  case 19:
                    console.log(
                      '\uD83C\uDFC6 "'
                        .concat(contest.name, "\" konkursi g'oliblari: ")
                        .concat(winners.length, " ta"),
                    );
                    _context8.next = 25;
                    break;
      ...
      },
      {
        ...
        value: function notifyContestStart(contest) {
          ...
          return regeneratorRuntime.async(
            function notifyContestStart$(_context10) {
              while (1) {
                switch ((_context10.prev = _context10.next)) {
                  ...
                  case 18:
                    ...
                    console.log(
                      "Foydalanuvchiga xabar yuborish xatosi: ".concat(
                        user.chatId,
                      ),
                    );
                  ...
                  case 40:
                    ...
                    console.error(
                      "Konkurs boshlanish xabarini yuborish xatosi:",
                      _context10.t2,
                    );
      ...
      },
      {
        ...
        value: function notifyContestEnd(contest) {
          ...
          return regeneratorRuntime.async(
            function notifyContestEnd$(_context11) {
              while (1) {
                switch ((_context11.prev = _context11.next)) {
                  ...
                  case 14:
                    ...
                    if (isWinner) {
                      ...
                      message +=
                        "\uD83C\uDFAF Konkursda qatnashganingiz uchun rahmat!\n";
                    ...
                    _context11.next = 23;
                    return regeneratorRuntime.awrap(
                      bot.sendMessage(participant.chatId, message, {
                        parse_mode: "Markdown",
                      }),
                    );
                  ...
                  case 47:
                    ...
                    console.error(
                      "Konkurs tugash xabarini yuborish xatosi:",
                      _context11.t2,
                    );
      ...
      },
      {
        ...
        value: function clearAllJobs() {
          ...
          try {
            for (
              var _iterator6 = this.jobs[Symbol.iterator](), _step6;
