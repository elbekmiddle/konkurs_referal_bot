...
var deleteLastMessage = function deleteLastMessage(chatId) {
  return regeneratorRuntime.async(
    function deleteLastMessage$(_context) {
      while (1) {
        switch ((_context.prev = _context.next)) {
          case 0:
            ...
            return regeneratorRuntime.awrap(
              bot.deleteMessage(chatId, userLastMessages[chatId]),
            );
...
var processReferral = function processReferral(referrerChatId, newUser) {
  var referrer;
  return regeneratorRuntime.async(
    function processReferral$(_context2) {
      while (1) {
        switch ((_context2.prev = _context2.next)) {
          case 0:
            ...
            console.log(
              "\uD83D\uDD0D Referal: "
                .concat(referrerChatId, " -> ")
                .concat(newUser.chatId),
            );
            _context2.next = 4;
            return regeneratorRuntime.awrap(
              User.findOne({
          ...
          case 8:
            ...
            _context2.next = 14;
            return regeneratorRuntime.awrap(
              Promise.all([referrer.save(), newUser.save()]),
            );
...
var handleStart = function handleStart(chatId) {
  var startParam,
    ...
    _args3 = arguments;
  return regeneratorRuntime.async(
    function handleStart$(_context3) {
      while (1) {
        switch ((_context3.prev = _context3.next)) {
          case 0:
            startParam =
              _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : null;
            _context3.prev = 1;
            console.log(
              "\uD83D\uDE80 Start: "
                .concat(chatId, ", param: ")
...
var showMainMenu = function showMainMenu(chatId) {
  ...
  return regeneratorRuntime.async(
    function showMainMenu$(_context4) {
      while (1) {
        switch ((_context4.prev = _context4.next)) {
          ...
          case 18:
            ...
            messageText = "\uD83C\uDF89 *Xush kelibsiz, "
              .concat(
                user.fullName || "Do'st",
                "!*\n\n\uD83D\uDCCA *Statistika:*\n\u2B50 Ball: ",
              )
              .concat(user.points, "\n\uD83D\uDC65 Takliflar: ")
              .concat(referredUsers.length, " ta");
            _context4.next = 22;
            return regeneratorRuntime.awrap(
              bot.sendMessage(
                chatId,
...
var handleCheckSubscription = function handleCheckSubscription(chatId) {
  ...
  return regeneratorRuntime.async(
    function handleCheckSubscription$(_context5) {
      while (1) {
        switch ((_context5.prev = _context5.next)) {
          ...
          case 29:
            _context5.next = 31;
            return regeneratorRuntime.awrap(
              showChannelsForSubscription(chatId, channels),
            );
          ...
          case 33:
            ...
            _context5.next = 38;
            return regeneratorRuntime.awrap(
              showChannelsForSubscription(chatId),
            );
...
var showChannelsForSubscription = function showChannelsForSubscription(chatId) {
  ...
  return regeneratorRuntime.async(
    function showChannelsForSubscription$(_context6) {
      while (1) {
        switch ((_context6.prev = _context6.next)) {
          case 0:
            channels =
              _args6.length > 1 && _args6[1] !== undefined ? _args6[1] : null;
            _context6.prev = 1;
            _context6.next = 4;
            return regeneratorRuntime.awrap(deleteLastMessage(chatId));
...
var handleConfirmSubscription = function handleConfirmSubscription(chatId) {
  ...
  return regeneratorRuntime.async(
    function handleConfirmSubscription$(_context7) {
      while (1) {
        switch ((_context7.prev = _context7.next)) {
          ...
          case 15:
            console.log(
              "\u2705 ".concat(chatId, " obuna bo'ldi, status yangilandi"),
            );
            _context7.next = 18;
            return regeneratorRuntime.awrap(
              bot.sendMessage(
...
var showUserStats = function showUserStats(chatId) {
  ...
  return regeneratorRuntime.async(
    function showUserStats$(_context8) {
      while (1) {
...
var showReferralInfo = function showReferralInfo(chatId) {
  ...
  return regeneratorRuntime.async(
    function showReferralInfo$(_context9) {
      while (1) {
        switch ((_context9.prev = _context9.next)) {
          ...
          case 12:
            referralLink = "https://t.me/"
              .concat(process.env.BOT_USERNAME, "?start=")
              .concat(chatId);
...
var showReferredFriends = function showReferredFriends(chatId) {
  ...
  return regeneratorRuntime.async(
    function showReferredFriends$(_context10) {
      while (1) {
...
var showLeaderboard = function showLeaderboard(chatId) {
  ...
  return regeneratorRuntime.async(
    function showLeaderboard$(_context11) {
      while (1) {
...
var handleDailyBonus = function handleDailyBonus(chatId) {
  ...
  return regeneratorRuntime.async(
    function handleDailyBonus$(_context12) {
      while (1) {
        switch ((_context12.prev = _context12.next)) {
          ...
          case 15:
            ...
            return regeneratorRuntime.awrap(
              bot.sendMessage(
                chatId,
                "\uD83C\uDF89 Kunlik bonus! 5 ball qo\u02BBshildi. Jami: ".concat(
                  user.points,
                  " ball",
                ),
              ),
