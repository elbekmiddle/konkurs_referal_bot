...
var getRealChannelId = function getRealChannelId(username) {
  ...
  return regeneratorRuntime.async(function getRealChannelId$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 4;
          url = "https://api.telegram.org/bot".concat(process.env.BOT_TOKEN, "/getChat?chat_id=").concat(chatId);
        ...
        case 9:
          ...
          console.log("\u2705 Kanal ID topildi: ".concat(id, " (").concat(chatId, ")"));
        ...
        case 16:
          ...
          console.log("\uD83D\uDCCA ID sifatida tekshirilmoqda: ".concat(username));
...
var startAddChannel = function startAddChannel(chatId) {
  return regeneratorRuntime.async(function startAddChannel$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '📢 *Yangi kanal qoʻshish*\n\n📝 *Kanal nomini kiriting:*\n\nMasalan: "Telegram Rasmiy Kanal"', {
            parse_mode: 'Markdown',
            reply_markup: {
              keyboard: [[{
                text: '❌ Bekor qilish'
...
var processAddChannel = function processAddChannel(chatId, msg) {
  ...
  return regeneratorRuntime.async(function processAddChannel$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          _context3.next = 9;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Kanal qoʻshish bekor qilindi.', {
            reply_markup: {
        ...
        case 10:
          ...
          _context3.next = _context3.t0 === 'name' ? 13 : _context3.t0 === 'username' ? 22 : 37;
          break;
        ...
        case 13:
          ...
          _context3.next = 16;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Kanal nomi boʻsh boʻlmasligi kerak. Iltimos, qayta kiriting:'));
        ...
        case 17:
          ...
          state.step = 'username';
          _context3.next = 21;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '🔗 *Kanal username yoki linkini kiriting:*\n\nMasalan: "@telegram" yoki "telegram" (t.me/ bilan emas)', {
            parse_mode: 'Markdown',
            reply_markup: {
              keyboard: [[{
                text: '❌ Bekor qilish'
        ...
        case 22:
          ...
          _context3.next = 25;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Kanal username boʻsh boʻlmasligi kerak. Iltimos, qayta kiriting:'));
        ...
        case 26:
          ...
          _context3.next = 35;
          return regeneratorRuntime.awrap(saveChannel(chatId, state.channelData));
        ...
        case 37:
          _context3.next = 39;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Nomaʻlum amal'));
...
var saveChannel = function saveChannel(chatId, channelData) {
  ...
  return regeneratorRuntime.async(function saveChannel$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          _context4.next = 7;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\u274C Bu kanal allaqachon mavjud!\n\n\uD83D\uDCDD Nomi: ".concat(existingChannel.name, "\n\uD83D\uDD17 Username: ").concat(existingChannel.username), {
            reply_markup: {
              remove_keyboard: true
            }
          }));
        ...
        case 8:
          _context4.next = 10;
          return regeneratorRuntime.awrap(getRealChannelId(channelData.username));
        ...
        case 15:
          // Linkni yaratish
          link = "https://t.me/".concat(channelData.username.replace('@', '')); // Yangi kanal yaratish
        ...
        case 19:
          successMessage = "\u2705 Kanal muvaffaqiyatli qo\u02BBshildi!\n\n" + "\uD83D\uDCDD Nomi: ".concat(channelData.name, "\n") + "\uD83D\uDD17 Username: ".concat(channelData.username, "\n") + "\uD83C\uDD94 ID: ".concat(realId, "\n") + "\uD83D\uDD17 Link: ".concat(link, "\n") + "\uD83D\uDCCA Holati: \uD83D\uDFE2 Faol";
          _context4.next = 22;
        ...
        case 22:
          console.log("\u2705 Yangi kanal qo\u02BBshildi: ".concat(channelData.name, " (ID: ").concat(realId, ")")); // Kanal ro'yxatiga qaytish
        ...
        case 27:
          ...
          _context4.next = 32;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Kanal saqlashda xatolik yuz berdi. Iltimos, qayta urinib koʻring.'));
...
var showChannelsList = function showChannelsList(chatId) {
  ...
  return regeneratorRuntime.async(function showChannelsList$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return regeneratorRuntime.awrap(Channel.find().sort({
            createdAt: -1
          }));
        ...
        case 3:
          ...
          message = "\uD83D\uDCCB *Kanallar ro\u02BByxati*\n\n" + "\uD83D\uDFE2 Faol: ".concat(activeChannels, " ta\n") + "\uD83D\uDD34 Nofaol: ".concat(channels.length - activeChannels, " ta\n") + "\uD83D\uDCCA Jami: ".concat(channels.length, " ta\n\n");
        ...
        case 13:
          ...
          console.error('❌ Kanallar roʻyxatini koʻrsatish xatosi:', _context5.t0);
          _context5.next = 18;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var showChannelDetail = function showChannelDetail(chatId, channelId) {
  var channel, status, subscriptionRequired, createdDate, message, inline_keyboard;
  return regeneratorRuntime.async(function showChannelDetail$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          _context6.next = 7;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Kanal topilmadi'));
        ...
        case 8:
          ...
          subscriptionRequired = channel.requiresSubscription ? '✅ Talab qilinadi' : '❌ Talab qilinmaydi';
          createdDate = new Date(channel.createdAt).toLocaleDateString('uz-UZ');
          message = "\uD83D\uDCFA *Kanal tafsilotlari*\n\n" + "\uD83D\uDCDD *Nomi:* ".concat(channel.name, "\n") + "\uD83D\uDD17 *Username:* ".concat(channel.username, "\n") + "\uD83D\uDD17 *Link:* ".concat(channel.link, "\n") + "\uD83C\uDD94 *ID:* ".concat(channel.channelId, "\n") + "\uD83D\uDCCA *Holati:* ".concat(status, "\n") + "\uD83D\uDD14 *Obuna talabi:* ".concat(subscriptionRequired, "\n") + "\uD83D\uDCC5 *Qo\u02BBshilgan sana:* ".concat(createdDate);
          inline_keyboard = [[{
            ...
            text: channel.requiresSubscription ? '🔕 Obunani majburiy emas qilish' : '🔔 Obunani majburiy qilish',
        ...
        case 17:
          ...
          console.error('❌ Kanal tafsilotlarini koʻrsatish xatosi:', _context6.t0);
          _context6.next = 22;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var toggleChannel = function toggleChannel(chatId, channelId) {
  var channel, status;
  return regeneratorRuntime.async(function toggleChannel$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 11:
          status = channel.isActive ? 'faol' : 'nofaol';
          _context7.next = 14;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\u2705 \"".concat(channel.name, "\" kanali ").concat(status, " holatga o'zgartirildi")));

        case 14:
          _context7.next = 16;
          return regeneratorRuntime.awrap(showChannelDetail(chatId, channelId));
        ...
        case 18:
          ...
          console.error('❌ Kanal holatini oʻzgartirish xatosi:', _context7.t0);
          _context7.next = 23;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var toggleSubscriptionRequirement = function toggleSubscriptionRequirement(chatId, channelId) {
  var channel, status;
  return regeneratorRuntime.async(function toggleSubscriptionRequirement$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 11:
          status = channel.requiresSubscription ? 'talab qilinadi' : 'talab qilinmaydi';
          _context8.next = 14;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\u2705 \"".concat(channel.name, "\" kanali uchun obuna ").concat(status)));
        ...
        case 18:
          ...
          console.error('❌ Obuna talabini oʻzgartirish xatosi:', _context8.t0);
          _context8.next = 23;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var deleteChannel = function deleteChannel(chatId, channelId) {
  ...
  return regeneratorRuntime.async(function deleteChannel$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 8:
          ...
          _context9.next = 12;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\u26A0\uFE0F *\"".concat(channelName, "\" kanalini o'chirishni tasdiqlaysizmi?*\n\nBu amalni qaytarib bo'lmaydi!"), {
            parse_mode: 'Markdown',
...
var confirmDeleteChannel = function confirmDeleteChannel(chatId, channelId) {
  ...
  return regeneratorRuntime.async(function confirmDeleteChannel$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 8:
          ...
          _context10.next = 11;
          return regeneratorRuntime.awrap(Channel.findByIdAndDelete(channelId));

        case 11:
          _context10.next = 13;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\u2705 *\"".concat(channelName, "\" kanali o'chirildi!*"), {
            parse_mode: 'Markdown'
          }));
        ...
        case 17:
          ...
          console.error("❌ Kanalni o'chirishni tasdiqlash xatosi:", _context10.t0);
          _context10.next = 22;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var startEditChannel = function startEditChannel(chatId, channelId) {
  var channel;
  return regeneratorRuntime.async(function startEditChannel$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 8:
          ...
          _context11.next = 11;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\u270F\uFE0F *Kanalni tahrirlash*\n\n\uD83D\uDCDD *Joriy nom:* ".concat(channel.name, "\n\n*Yangi nomni kiriting:*"), {
            parse_mode: 'Markdown',
            reply_markup: {
              keyboard: [[{
                text: '❌ Bekor qilish'
        ...
        case 13:
          ...
          console.error('❌ Kanal tahrirlashni boshlash xatosi:', _context11.t0);
          _context11.next = 18;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var processEditChannel = function processEditChannel(chatId, msg) {
  var state, text, cleanedText;
  return regeneratorRuntime.async(function processEditChannel$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 4:
          ...
          delete userStates[chatId];
          _context12.next = 9;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Tahrirlash bekor qilindi.', {
            reply_markup: {
              remove_keyboard: true
            }
          }));
        ...
        case 10:
          ...
          _context12.next = _context12.t0 === 'name' ? 13 : _context12.t0 === 'username' ? 22 : 37;
          break;
        ...
        case 17:
          ...
          state.step = 'username';
          _context12.next = 21;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\uD83D\uDD17 *Yangi kanal username kiriting:*\n\nJoriy: ".concat(state.channelData.username), {
            parse_mode: 'Markdown',
            reply_markup: {
              keyboard: [[{
                text: '❌ Bekor qilish'
        ...
        case 26:
          ...
          state.channelData.username = cleanedText;
          _context12.next = 35;
          return regeneratorRuntime.awrap(updateChannel(chatId, state.channelId, state.channelData));
        ...
        case 42:
          ...
          console.error('❌ Kanal tahrirlash jarayoni xatosi:', _context12.t1);
          _context12.next = 47;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var updateChannel = function updateChannel(chatId, channelId, channelData) {
  ...
  return regeneratorRuntime.async(function updateChannel$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 8:
          // Linkni yaratish
          link = "https://t.me/".concat(channelData.username.replace('@', ''));
          _context13.next = 11;
          return regeneratorRuntime.awrap(Channel.findByIdAndUpdate(channelId, {
            name: channelData.name,
            username: channelData.username,
            link: link,
            channelId: realId
        ...
        case 11:
          successMessage = "\u2705 *Kanal muvaffaqiyatli yangilandi!*\n\n" + "\uD83D\uDCDD *Yangi nom:* ".concat(channelData.name, "\n") + "\uD83D\uDD17 *Yangi username:* ".concat(channelData.username, "\n") + "\uD83C\uDD94 *Yangi ID:* ".concat(realId, "\n") + "\uD83D\uDD17 *Yangi link:* ".concat(link);
          _context13.next = 14;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, successMessage, {
            parse_mode: 'Markdown',
            reply_markup: {
        ...
        case 14:
          console.log("\u2705 Kanal yangilandi: ".concat(channelData.name, " (ID: ").concat(realId, ")")); // Yangilangan kanal tafsilotlariga qaytish
        ...
        case 19:
          ...
          _context13.next = 24;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Kanal yangilashda xatolik yuz berdi'));
...
var getActiveChannels = function getActiveChannels() {
  return regeneratorRuntime.async(function getActiveChannels$(_context14) {
    while (1) {
...
var checkUserSubscription = function checkUserSubscription(chatId) {
  ...
  return regeneratorRuntime.async(function checkUserSubscription$(_context15) {
    while (1) {
...
var checkUserSubscriptionSimple = function checkUserSubscriptionSimple(chatId) {
  var channels, subscriptionResults;
  return regeneratorRuntime.async(function checkUserSubscriptionSimple$(_context16) {
    while (1) {
      switch (_context16.prev = _context16.next) {
        ...
        case 10:
          ...
          console.error('❌ Soddalashtirilgan obuna tekshirish xatosi:', _context16.t0);
          return _context16.abrupt("return", {
            subscribed: false,
            channels: [],
            requiresManualCheck: true
...
var showUserChannels = function showUserChannels(chatId) {
  var subscriptionResult,
      ...
      inline_keyboard,
      _args17 = arguments;
  return regeneratorRuntime.async(function showUserChannels$(_context17) {
    while (1) {
      switch (_context17.prev = _context17.next) {
        case 0:
          subscriptionResult = _args17.length > 1 && _args17[1] !== undefined ? _args17[1] : null;
          _context17.prev = 1;
          channels = [];
          message = '';
        ...
        case 40:
          ...
          console.error('❌ Foydalanuvchi uchun kanallarni koʻrsatish xatosi:', _context17.t0);
          _context17.next = 45;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var confirmUserSubscription = function confirmUserSubscription(chatId) {
  var user;
  return regeneratorRuntime.async(function confirmUserSubscription$(_context18) {
    while (1) {
