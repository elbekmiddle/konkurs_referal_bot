...
var showAdminPanel = function showAdminPanel(chatId) {
  ...
  return regeneratorRuntime.async(function showAdminPanel$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 7;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Siz admin emassiz.'));
        ...
        case 22:
          ...
          _context.next = 27;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "❌ Admin panelni ko'rsatishda xatolik."));
...
var handleAdminStatistics = function handleAdminStatistics(chatId) {
  var totalUsers, subscribedUsers, totalContests, activeContests, topUsers, statsMessage;
  return regeneratorRuntime.async(function handleAdminStatistics$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 12:
          ...
          return regeneratorRuntime.awrap(User.find({}).sort({
            points: -1
          }).limit(5).select('username fullName points referrals'));

        case 15:
          topUsers = _context2.sent;
          // TO'G'RILANGAN: Markdown emas
          statsMessage = "\uD83D\uDCCA Umumiy statistika:\n\n";
          statsMessage += "\uD83D\uDC65 Jami foydalanuvchilar: ".concat(totalUsers, "\n");
          statsMessage += "\u2705 Obuna bo'lganlar: ".concat(subscribedUsers, "\n");
          statsMessage += "\uD83C\uDFAF Jami konkurslar: ".concat(totalContests, "\n");
          statsMessage += "\uD83D\uDD25 Faol konkurslar: ".concat(activeContests, "\n\n");
          statsMessage += "\uD83C\uDFC6 Top 5 foydalanuvchi:\n";
          topUsers.forEach(function (user, index) {
            statsMessage += "".concat(index + 1, ". ").concat(user.fullName, " - ").concat(user.points, " ball (").concat(user.referrals, " taklif)\n");
          });
          _context2.next = 25;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, statsMessage, backKeyboard));
        ...
        case 27:
          ...
          _context2.next = 32;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "❌ Statistika ko'rsatishda xatolik."));
  ...
  return regeneratorRuntime.async(function handleUserManagement$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '👥 Foydalanuvchilar boshqaruvi', userManagementKeyboard));
  ...
  return regeneratorRuntime.async(function handleContestManagement$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '🎯 Konkurslar boshqaruvi', contestManagementKeyboard));
...
var handleChannelManagement = function handleChannelManagement(chatId) {
  ...
  return regeneratorRuntime.async(function handleChannelManagement$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          _context5.next = 6;
          return regeneratorRuntime.awrap(channelController.getActiveChannels());

        case 6:
          activeChannels = _context5.sent;
          message = "\uD83D\uDCE2 Kanallar boshqaruvi\n\n" + "\uD83D\uDFE2 Faol kanallar: ".concat(activeChannels.length, " ta\n") + "\uD83D\uDD34 Nofaol kanallar: ".concat(channels.length - activeChannels.length, " ta\n") + "\uD83D\uDCCA Jami: ".concat(channels.length, " ta\n\n") + "Quyidagi amallardan birini tanlang:";
          _context5.next = 10;
        ...
        case 12:
          ...
          console.error('❌ Kanal boshqaruvini koʻrsatish xatosi:', _context5.t0);
          _context5.next = 17;
  ...
  return regeneratorRuntime.async(function handleSettings$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '⚙️ Sozlamalar', settingsKeyboard));
...
var handleBroadcast = function handleBroadcast(chatId) {
  var totalUsers;
  return regeneratorRuntime.async(function handleBroadcast$(_context7) {
    while (1) {
...
var processBroadcast = function processBroadcast(chatId, msg) {
  ...
  return regeneratorRuntime.async(function processBroadcast$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          _context8.next = 8;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Reklama yuborish bekor qilindi.', {
        ...
        case 9:
          ...
          _context8.next = 18;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, previewMessage, _objectSpread({
            parse_mode: 'Markdown'
          }, confirmKeyboard)));
        ...
        case 20:
          ...
          _context8.next = 24;
          return regeneratorRuntime.awrap(bot.sendPhoto(chatId, msg.photo[msg.photo.length - 1].file_id, _objectSpread({
        ...
        case 26:
          ...
          _context8.next = 30;
          return regeneratorRuntime.awrap(bot.sendVideo(chatId, msg.video.file_id, _objectSpread({
            caption: previewMessage,
            parse_mode: 'Markdown'
          }, confirmKeyboard)));
        ...
        case 32:
          ...
          _context8.next = 36;
          return regeneratorRuntime.awrap(bot.sendDocument(chatId, msg.document.file_id, _objectSpread({
            caption: previewMessage,
            parse_mode: 'Markdown'
          }, confirmKeyboard)));
        ...
        case 38:
          _context8.next = 40;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Qoʻllab-quvvatlanmaydigan xabar turi.', {
            reply_markup: adminKeyboard.reply_markup
          }));
...
var sendBroadcast = function sendBroadcast(chatId) {
  var state, users, totalUsers, successCount, failCount, progressMessage, i, user, progress, resultMessage;
  return regeneratorRuntime.async(function sendBroadcast$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          ...
          _context9.next = 5;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xabar topilmadi'));
        ...
        case 16:
          ...
          _context9.next = 22;
          return regeneratorRuntime.awrap(bot.sendMessage(user.chatId, state.message.text));
        ...
        case 24:
          ...
          _context9.next = 27;
          return regeneratorRuntime.awrap(bot.sendPhoto(user.chatId, state.message.photo[state.message.photo.length - 1].file_id, {
        ...
        case 29:
          ...
          _context9.next = 32;
          return regeneratorRuntime.awrap(bot.sendVideo(user.chatId, state.message.video.file_id, {
            caption: state.message.caption || ''
          }));
        ...
        case 34:
          ...
          _context9.next = 37;
          return regeneratorRuntime.awrap(bot.sendDocument(user.chatId, state.message.document.file_id, {
            caption: state.message.caption || ''
          }));
        ...
        case 40:
          ...
          console.error("\u274C Xabar yuborish xatosi (".concat(user.chatId, "):"), _context9.t0);
          failCount++;
        ...
        case 44:
          ...
          _context9.prev = 46;
          _context9.next = 49;
          return regeneratorRuntime.awrap(bot.editMessageText("\uD83D\uDCE4 Xabar yuborilmoqda...\n\n" + "\uD83D\uDC65 Jami: ".concat(totalUsers, " ta\n") + "\u2705 Muvaffaqiyatli: ".concat(successCount, " ta\n") + "\u274C Xatolar: ".concat(failCount, " ta\n") + "\uD83D\uDCCA Progress: ".concat(progress, "%"), {
            chat_id: chatId,
        ...
        case 59:
          // Yakuniy natija
          resultMessage = "\uD83D\uDCE2 *Reklama yuborish yakunlandi!*\n\n" + "\uD83D\uDC65 Jami foydalanuvchilar: ".concat(totalUsers, " ta\n") + "\u2705 Muvaffaqiyatli yuborildi: ".concat(successCount, " ta\n") + "\u274C Yuborilmadi: ".concat(failCount, " ta\n") + "\uD83D\uDCCA Muvaffaqiyat darajasi: ".concat(Math.round(successCount / totalUsers * 100), "%");
          _context9.next = 62;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, resultMessage, {
            parse_mode: 'Markdown',
            reply_markup: adminKeyboard.reply_markup
          }));
        ...
        case 65:
          ...
          _context9.next = 70;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Reklama yuborishda xatolik yuz berdi.', {
            reply_markup: adminKeyboard.reply_markup
          }));
  ...
  }, null, null, [[0, 65], [18, 40], [46, 51]]);
};

var cancelBroadcast = function cancelBroadcast(chatId) {
  return regeneratorRuntime.async(function cancelBroadcast$(_context10) {
    while (1) {
...
var handleCreateContest = function handleCreateContest(chatId) {
  return regeneratorRuntime.async(function handleCreateContest$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        case 0:
          _context11.prev = 0;
          _context11.next = 3;
          return regeneratorRuntime.awrap(contestController.startContestCreation(chatId));
  ...
  return regeneratorRuntime.async(function handleNotImplemented$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        case 0:
          _context12.next = 2;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, "\uD83D\uDEA7 ".concat(feature, " bo'limi hozircha ishlab chiqilmoqda...\n\n") + "Tez orada qo'shiladi!", backKeyboard));
...
var showAllUsers = function showAllUsers(chatId) {
  var page,
      ...
      navButtons,
      _args13 = arguments;
  return regeneratorRuntime.async(function showAllUsers$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(User.find({}).sort({
            joinDate: -1
          }).skip(skip).limit(pageSize).select('username fullName points referrals joinDate isSubscribed chatId'));
        ...
        case 9:
          ...
          message += "\uD83D\uDCCA Jami: ".concat(totalUsers, " ta foydalanuvchi\n");
          message += "\uD83D\uDCC4 Sahifa: ".concat(page, "/").concat(totalPages, "\n\n");
          ...
          if (users.length === 0) {
            ...
            users.forEach(function (user, index) {
              ...
              var joinDate = new Date(user.joinDate).toLocaleDateString('uz-UZ');
              var status = user.isSubscribed ? '✅' : '❌';
              var username = user.username ? "@".concat(user.username) : "Noma'lum";
              message += "".concat(userNumber, ". ").concat(user.fullName, "\n");
              message += "   \uD83D\uDC64 ".concat(username, "\n");
              message += "   \u2B50 ".concat(user.points, " ball | \uD83D\uDC65 ").concat(user.referrals, " taklif\n");
              message += "   \uD83D\uDCC5 ".concat(joinDate, " | ").concat(status, "\n\n");
            });
          } // Keyboard yaratish
          ...
          users.forEach(function (user) {
            inline_keyboard.push([{
              text: "".concat(user.fullName, " (").concat(user.points, "\u2B50)"),
        ...
        case 28:
          ...
          console.error('❌ Foydalanuvchilar roʻyxatini koʻrsatish xatosi:', _context13.t0);
          _context13.next = 33;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var showTopUsers = function showTopUsers(chatId) {
  ...
  return regeneratorRuntime.async(function showTopUsers$(_context14) {
    while (1) {
      switch (_context14.prev = _context14.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(User.find({}).sort({
            points: -1
          }).limit(20).select('username fullName points referrals joinDate isSubscribed'));
        ...
        case 3:
          ...
          if (topUsers.length === 0) {
            ...
            topUsers.forEach(function (user, index) {
              var medal = index < 3 ? ['🥇', '🥈', '🥉'][index] : "".concat(index + 1, ".");
              var joinDate = new Date(user.joinDate).toLocaleDateString('uz-UZ');
              var status = user.isSubscribed ? '✅' : '❌';
        ...
        case 11:
          ...
          console.error('❌ Top foydalanuvchilarni koʻrsatish xatosi:', _context14.t0);
          _context14.next = 16;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
...
var showRecentUsers = function showRecentUsers(chatId) {
  ...
  return regeneratorRuntime.async(function showRecentUsers$(_context15) {
    while (1) {
      switch (_context15.prev = _context15.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(User.find({
            ...
            joinDate: -1
          }).limit(15).select('username fullName points referrals joinDate isSubscribed'));
        ...
        case 8:
          ...
          message += "\uD83D\uDCC5 So'nggi 7 kunda: ".concat(totalRecent, " ta\n\n");
          ...
          if (recentUsers.length === 0) {
            ...
            recentUsers.forEach(function (user, index) {
              ...
              var status = user.isSubscribed ? '✅' : '❌';
              var username = user.username ? "@".concat(user.username) : "Noma'lum";
              message += "".concat(index + 1, ". ").concat(user.fullName, "\n");
              message += "   \uD83D\uDC64 ".concat(username, "\n");
              message += "   \u2B50 ".concat(user.points, " ball | \uD83D\uDC65 ").concat(user.referrals, " taklif\n");
              message += "   \uD83D\uDCC5 ".concat(joinDate, " | ").concat(status, "\n\n");
            });
        ...
        case 17:
          ...
          console.error('❌ Yangi foydalanuvchilarni koʻrsatish xatosi:', _context15.t0);
          _context15.next = 22;
          return regeneratorRuntime.awrap(bot.sendMessage(chatId, '❌ Xatolik yuz berdi'));
