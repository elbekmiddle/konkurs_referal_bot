...
function () {
  ...
  _createClass(ContestScheduler, [{
    ...
    value: function initialize() {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              for (_iterator = contests[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                contest = _step.value;
      ...
      }, null, this, [[1, 28], [8, 12, 16, 24], [17,, 19, 23]]);
    }
  }, {
    key: "scheduleContest",
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              console.log("\uD83C\uDFC1 Konkurs tugadi: ".concat(contest.name));
              _context7.next = 8;
      ...
      return regeneratorRuntime.async(function selectWinners$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 7:
              // Oddiy random tanlov
              shuffled = _toConsumableArray(contest.participants).sort(function () {
            ...
            case 12:
              console.log("\uD83C\uDFC6 Konkurs g'oliblari: ".concat(winners.length, " ta"));
              _context8.next = 18;
              break;
