...
function () {
  ...
  _createClass(ChannelService, null, [{
    ...
    value: function getChannelIdFromLink(link, bot) {
      ...
      return regeneratorRuntime.async(function getChannelIdFromLink$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return regeneratorRuntime.awrap(bot.getChat("@".concat(username)));

            case 5:
              chat = _context.sent;
              return _context.abrupt("return", chat.id.toString().replace('-100', ''));
            ...
            case 7:
              ...
              _context.next = 11;
              return regeneratorRuntime.awrap(bot.getChat("@".concat(_username)));

            case 11:
              _chat = _context.sent;
              return _context.abrupt("return", _chat.id.toString().replace('-100', ''));
    ...
    value: function checkUserSubscription(chatId, channelId, bot) {
      ...
      return regeneratorRuntime.async(function checkUserSubscription$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              fullChannelId = channelId.startsWith('-100') ? channelId : "-100".concat(channelId);
              _context2.next = 6;
              return regeneratorRuntime.awrap(bot.getChatMember(fullChannelId, chatId));

            case 6:
              member = _context2.sent;
              return _context2.abrupt("return", ['member', 'administrator', 'creator'].includes(member.status));
    ...
    value: function checkAllSubscriptions(chatId, bot) {
      var channels, allSubscribed, results, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, channel, isSubscribed;

      return regeneratorRuntime.async(function checkAllSubscriptions$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 11:
              ...
              channel = _step.value;
              _context3.next = 15;
              return regeneratorRuntime.awrap(this.checkUserSubscription(chatId, channel.channelId, bot));
            ...
            case 38:
              ...
              console.error('Barcha obunalarni tekshirishda xato:', _context3.t1);
              return _context3.abrupt("return", {
                allSubscribed: false,
                results: []
              });
      ...
      }, null, this, [[0, 38], [9, 23, 27, 35], [28,, 30, 34]]);
    } // Kanal qo'shish
    ...
    value: function addChannel(channelName, channelLink, bot) {
      ...
      return regeneratorRuntime.async(function addChannel$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return regeneratorRuntime.awrap(this.getChannelIdFromLink(channelLink, bot));
      ...
      return regeneratorRuntime.async(function deleteChannel$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return regeneratorRuntime.awrap(Channel.findOneAndDelete({
                channelName: channelName
              }));
