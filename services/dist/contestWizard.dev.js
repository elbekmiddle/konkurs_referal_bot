...
function () {
  ...
  _createClass(ContestWizard, [{
    ...
    value: function startWizard(chatId) {
      ...
      return {
        step: 'name',
        message: '🎯 Yangi konkurs yaratish boshlandi!\n\n**1-bosqich:** Konkurs nomini kiriting:'
      };
    }
  }, {
    key: "handleStep",
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _context.next = _context.t0 === 'name' ? 7 : _context.t0 === 'description' ? 8 : _context.t0 === 'points' ? 9 : _context.t0 === 'bonus' ? 10 : _context.t0 === 'image' ? 11 : _context.t0 === 'start_date' ? 14 : _context.t0 === 'end_date' ? 15 : _context.t0 === 'confirm' ? 16 : 17;
              break;
            ...
            case 8:
              return _context.abrupt("return", this.handleDescription(input, session));

            case 9:
              return _context.abrupt("return", this.handlePoints(input, session));

            case 10:
              return _context.abrupt("return", this.handleBonus(input, session));

            case 11:
              _context.next = 13;
              return regeneratorRuntime.awrap(this.handleImage(chatId, input, session, bot));

            case 13:
              return _context.abrupt("return", _context.sent);

            case 14:
              return _context.abrupt("return", this.handleStartDate(input, session));

            case 15:
              return _context.abrupt("return", this.handleEndDate(input, session));
    ...
    value: function handleName(input, session) {
      if (input.length < 3) {
        throw new Error("Konkurs nomi kamida 3 ta belgidan iborat bo'lishi kerak");
      }
      ...
      return regeneratorRuntime.async(function handleImage$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              file = _context2.sent;
              imageUrl = "https://api.telegram.org/file/bot".concat(process.env.BOT_TOKEN, "/").concat(file.file_path); // Cloudinary ga yuklash

              _context2.next = 8;
              return regeneratorRuntime.awrap(CloudinaryService.uploadImage(imageUrl));
            ...
            case 22:
              throw new Error('Iltimos, rasm yuboring yoki "O\'tkazib yuborish" tugmasini bosing');

            case 23:
              session.step = 'start_date';
              return _context2.abrupt("return", {
                step: 'start_date',
                message: "\u2705 ".concat(session.data.image ? 'Rasm muvaffaqiyatli yuklandi!' : "Rasm o'tkazib yuborildi!", "\n\n**6-bosqich:** Konkurs boshlanish sanasini kiriting:\n\n\uD83D\uDCC5 *Format: YYYY-MM-DD*\n*Misol: 2025-01-15*")
              });
    ...
    value: function handleStartDate(input, session) {
      ...
      if (isNaN(startDate.getTime())) {
        throw new Error("Noto'g'ri sana formati. Iltimos, YYYY-MM-DD formatida kiriting");
      }
      ...
      return {
        step: 'end_date',
        message: "\u2705 **Boshlanish sanasi saqlandi: ".concat(startDate.toLocaleDateString(), "**\n\n**7-bosqich:** Konkurs tugash sanasini kiriting:\n\n\uD83D\uDCC5 *Format: YYYY-MM-DD*\n*Misol: 2025-02-15*")
      };
    }
  }, {
    key: "handleEndDate",
    ...
    value: function handleConfirm(chatId, input, session) {
      var contest;
      return regeneratorRuntime.async(function handleConfirm$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              contest = new Contest(_objectSpread({}, session.data, {
                isActive: false,
                participants: [],
                winners: [],
                createdAt: new Date()
            ...
            case 6:
              ...
              return _context3.abrupt("return", {
                step: 'completed',
                message: "\uD83C\uDF89 **Konkurs muvaffaqiyatli yaratildi!**\n\n\uD83C\uDFC6 *".concat(session.data.name, "*\n\nKonkurs avtomatik ravishda:\n\uD83D\uDCC5 ").concat(session.data.startDate.toLocaleDateString(), " - boshlanadi\n\uD83D\uDCC5 ").concat(session.data.endDate.toLocaleDateString(), " - tugaydi"),
                completed: true,
    ...
    value: function formatContestInfo(data) {
      var info = "\uD83C\uDFC6 **Nomi:** ".concat(data.name, "\n\uD83D\uDCDD **Tavsif:** ").concat(data.description, "\n\uD83D\uDCB0 **Asosiy mukofot:** ").concat(data.points, " ball\n\uD83C\uDF81 **Bonus:** ").concat(data.bonus, " ball\n\uD83D\uDCC5 **Boshlanish:** ").concat(data.startDate.toLocaleDateString(), "\n\uD83D\uDCC5 **Tugash:** ").concat(data.endDate.toLocaleDateString());
