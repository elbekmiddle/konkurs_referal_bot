      ...
      return regeneratorRuntime.async(function uploadImage$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              folder = _args.length > 1 && _args[1] !== undefined ? _args[1] : 'contest_images';
              _context.prev = 1;
              _context.next = 4;
              return regeneratorRuntime.awrap(cloudinary.uploader.upload(imageUrl, {
                folder: folder,
                quality: 'auto',
                fetch_format: 'auto'
              }));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return regeneratorRuntime.awrap(cloudinary.uploader.destroy(publicId));
